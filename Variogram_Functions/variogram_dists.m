function S = variogram_dists(x,y,iid,num,varargin)

% This function is equivalent to variogram except that it also requires iid
%   and num as inputs to save time once those are already computed after
%   running the variogram function.
% 
...
%   iid - column vector with all distances. Obtained by running 'variogram'
%   num - column vector with number of observations at each distance. Obtained by running 'variogram'
%
