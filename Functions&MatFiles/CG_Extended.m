function [x,iter_hist,term_code] = CG_Extended(x0,b,params,a_mult)

% This function is equivalent to CG, but only the inner region is used to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  while term_code == 0
    ...
    snorm_d = d(sqrt_n/4+1:3*sqrt_n/4,sqrt_n/4+1:3*sqrt_n/4);               % Added this line
    snorm = abs(tau)*norm(snorm_d(:));                                      % and changed this one.
